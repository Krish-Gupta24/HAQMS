...
>>>>>>> 5aadcdd78417cfc8ace5b75f9e483d547dc6c1c7
  ...
  //
  // STALE CLOSURE FIX:
  // Use functional state update so polling count remains accurate.
  useEffect(() => {
    // Initial fetch
    fetchQueueData();
    ...
    // IMPORTANT:
    // Prevent memory leaks and multiple background polling intervals.
    return () => {
